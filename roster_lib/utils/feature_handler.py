...
MANUAL_DROP_COLS = {'Score': ['TS_PCT','DD2', 'TD3', 'FG2A_FREQUENCY', 'FG3A_FREQUENCY'],
             'Misc': ['DIST_MILES', 'AVG_SPEED', 'LOOSE_BALLS_RECOVERED', 'DIST_MILES_OFF', 'DIST_MILES_DEF',],
             'Defense': ['FREQ','D_FGM','D_FGA'],
             'Pass': ['TOUCHES','PAINT_TOUCH_PASSES_PCT', 'POST_TOUCH_PASSES_PCT',
                'ELBOW_TOUCH_PASSES_PCT', 'DRIVE_PASSES_PCT','PAINT_TOUCH_TOV_PCT',
                'POST_TOUCH_TOV_PCT','ELBOW_TOUCH_TOV_PCT','DRIVE_TOV_PCT',
                'PAINT_TOUCH_AST_PCT','POST_TOUCH_AST_PCT','ELBOW_TOUCH_AST_PCT','DRIVE_AST_PCT'],
             'Rebound': ['BOX_OUTS', 'OREB_CHANCES', 'DREB_CHANCES']}
